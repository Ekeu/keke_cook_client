...
export const CATEGORY_SUBCATEGORIES_LIST_REQUEST = 'CATEGORY_SUBCATEGORIES_REQUEST';
export const CATEGORY_SUBCATEGORIES_LIST_SUCCESS = 'CATEGORY_SUBCATEGORIES_SUCCESS';
export const CATEGORY_SUBCATEGORIES_LIST_FAIL = 'CATEGORY_SUBCATEGORIES_FAIL';
export const CATEGORY_SUBCATEGORIES_LIST_RESET = 'CATEGORY_SUBCATEGORIES_RESET';
